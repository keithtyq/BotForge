    ...
    <div className="animate-in fade-in duration-500">
        ...
        <div className="border border-gray-300 rounded-xl p-6 mb-6">
            ...
            <div className="relative">
                <select className="w-full appearance-none border border-gray-300 rounded-lg py-2 px-4 text-gray-500 text-sm bg-white outline-none focus:border-blue-500">
        ...
        <div className="border border-gray-300 rounded-xl p-6 mb-8">
            ...
            <textarea 
                className="w-full h-32 border border-gray-300 rounded-lg p-4 text-sm text-gray-600 outline-none focus:border-blue-500 resize-none"
