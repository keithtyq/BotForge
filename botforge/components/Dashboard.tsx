...
export const Dashboard: React.FC<DashboardProps> = ({ onLogout, onSystemAdminLogin }) => {
            ...
            <div className="flex items-center gap-6">
                ...
                <div className="flex items-center gap-3">
                    <div className="text-right">
                        <p className="text-sm font-bold text-gray-900">Hi, {currentRole === UserRole.ADMIN ? 'Robby' : 'user1'}</p>
                    ...
                    <div className="h-9 w-9 rounded-full bg-blue-100 text-blue-600 flex items-center justify-center font-bold text-sm">
                        {currentRole === UserRole.ADMIN ? 'R' : 'U1'}
                    </div>
                </div>
